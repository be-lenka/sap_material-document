...
namespace BeLenka\SAP\MaterialDocument;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://:/sap/opu/odata/sap/API_MATERIAL_DOCUMENT_SRV';
    ...
    {
        $report  = 'PHP SDK (BeLenka\SAP\MaterialDocument) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://{host}:{port}/sap/opu/odata/sap/API_MATERIAL_DOCUMENT_SRV",
            ...
            [
                "url" => "https://sandbox.api.sap.com/s4hanacloud/sap/opu/odata/sap/API_MATERIAL_DOCUMENT_SRV",
                "description" => "No description provided",
            ]
        ];
    }
