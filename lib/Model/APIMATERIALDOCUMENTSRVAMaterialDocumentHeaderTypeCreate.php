...
/**
 * APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\MaterialDocument
 * @author   OpenAPI Generator team
 ...
 */
class APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_MATERIAL_DOCUMENT_SRV.A_MaterialDocumentHeaderType-create';
    ...
    protected static $openAPITypes = [
        ...
        'to_material_document_item' => '\BeLenka\SAP\MaterialDocument\Model\APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreateToMaterialDocumentItem'
    ];
    ...
    */
    ...
    public function setMaterialDocumentYear($material_document_year)
    {
        ...
        if ((mb_strlen($material_document_year) > 4)) {
            throw new \InvalidArgumentException('invalid length for $material_document_year when calling APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setMaterialDocument($material_document)
    {
        ...
        if ((mb_strlen($material_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $material_document when calling APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setInventoryTransactionType($inventory_transaction_type)
    {
        ...
        if (!is_null($inventory_transaction_type) && (mb_strlen($inventory_transaction_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $inventory_transaction_type when calling APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setCreatedByUser($created_by_user)
    {
        ...
        if (!is_null($created_by_user) && (mb_strlen($created_by_user) > 12)) {
            throw new \InvalidArgumentException('invalid length for $created_by_user when calling APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreate., must be smaller than or equal to 12.');
        }
    ...
    public function setMaterialDocumentHeaderText($material_document_header_text)
    {
        ...
        if (!is_null($material_document_header_text) && (mb_strlen($material_document_header_text) > 25)) {
            throw new \InvalidArgumentException('invalid length for $material_document_header_text when calling APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreate., must be smaller than or equal to 25.');
        }
    ...
    public function setReferenceDocument($reference_document)
    {
        ...
        if (!is_null($reference_document) && (mb_strlen($reference_document) > 16)) {
            throw new \InvalidArgumentException('invalid length for $reference_document when calling APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreate., must be smaller than or equal to 16.');
        }
    ...
    public function setVersionForPrintingSlip($version_for_printing_slip)
    {
        ...
        if (!is_null($version_for_printing_slip) && (mb_strlen($version_for_printing_slip) > 1)) {
            throw new \InvalidArgumentException('invalid length for $version_for_printing_slip when calling APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setManualPrintIsTriggered($manual_print_is_triggered)
    {
        ...
        if (!is_null($manual_print_is_triggered) && (mb_strlen($manual_print_is_triggered) > 1)) {
            throw new \InvalidArgumentException('invalid length for $manual_print_is_triggered when calling APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setCtrlPostgForExtWhseMgmtSyst($ctrl_postg_for_ext_whse_mgmt_syst)
    {
        ...
        if (!is_null($ctrl_postg_for_ext_whse_mgmt_syst) && (mb_strlen($ctrl_postg_for_ext_whse_mgmt_syst) > 1)) {
            throw new \InvalidArgumentException('invalid length for $ctrl_postg_for_ext_whse_mgmt_syst when calling APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setGoodsMovementCode($goods_movement_code)
    {
        ...
        if (!is_null($goods_movement_code) && (mb_strlen($goods_movement_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $goods_movement_code when calling APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreate., must be smaller than or equal to 2.');
        }
     ...
     *
     * @return \BeLenka\SAP\MaterialDocument\Model\APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreateToMaterialDocumentItem|null
     */
     ...
     *
     * @param \BeLenka\SAP\MaterialDocument\Model\APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderTypeCreateToMaterialDocumentItem|null $to_material_document_item to_material_document_item
     *
     * @return self
     */
