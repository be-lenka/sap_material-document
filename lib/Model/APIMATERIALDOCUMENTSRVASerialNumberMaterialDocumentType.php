...
/**
 * APIMATERIALDOCUMENTSRVASerialNumberMaterialDocumentType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\MaterialDocument
 * @author   OpenAPI Generator team
 ...
 */
class APIMATERIALDOCUMENTSRVASerialNumberMaterialDocumentType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_MATERIAL_DOCUMENT_SRV.A_SerialNumberMaterialDocumentType';
    ...
    */
    ...
    public function setMaterial($material)
    {
        ...
        if ((mb_strlen($material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $material when calling APIMATERIALDOCUMENTSRVASerialNumberMaterialDocumentType., must be smaller than or equal to 40.');
        }
    ...
    public function setSerialNumber($serial_number)
    {
        ...
        if ((mb_strlen($serial_number) > 18)) {
            throw new \InvalidArgumentException('invalid length for $serial_number when calling APIMATERIALDOCUMENTSRVASerialNumberMaterialDocumentType., must be smaller than or equal to 18.');
        }
    ...
    public function setMaterialDocument($material_document)
    {
        ...
        if ((mb_strlen($material_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $material_document when calling APIMATERIALDOCUMENTSRVASerialNumberMaterialDocumentType., must be smaller than or equal to 10.');
        }
    ...
    public function setMaterialDocumentItem($material_document_item)
    {
        ...
        if ((mb_strlen($material_document_item) > 4)) {
            throw new \InvalidArgumentException('invalid length for $material_document_item when calling APIMATERIALDOCUMENTSRVASerialNumberMaterialDocumentType., must be smaller than or equal to 4.');
        }
    ...
    public function setMaterialDocumentYear($material_document_year)
    {
        ...
        if ((mb_strlen($material_document_year) > 4)) {
            throw new \InvalidArgumentException('invalid length for $material_document_year when calling APIMATERIALDOCUMENTSRVASerialNumberMaterialDocumentType., must be smaller than or equal to 4.');
        }
    ...
    public function setManufacturerSerialNumber($manufacturer_serial_number)
    {
        ...
        if (!is_null($manufacturer_serial_number) && (mb_strlen($manufacturer_serial_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $manufacturer_serial_number when calling APIMATERIALDOCUMENTSRVASerialNumberMaterialDocumentType., must be smaller than or equal to 30.');
        }
