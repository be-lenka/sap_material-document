...
/**
 * APIMATERIALDOCUMENTSRVAMaterialDocumentItemType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\MaterialDocument
 * @author   OpenAPI Generator team
 ...
 */
class APIMATERIALDOCUMENTSRVAMaterialDocumentItemType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_MATERIAL_DOCUMENT_SRV.A_MaterialDocumentItemType';
    ...
    protected static $openAPITypes = [
        ...
        'to_material_document_header' => '\BeLenka\SAP\MaterialDocument\Model\APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderType',
        'to_serial_numbers' => '\BeLenka\SAP\MaterialDocument\Model\APIMATERIALDOCUMENTSRVAMaterialDocumentItemTypeToSerialNumbers'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['material_document_item']) && (mb_strlen($this->container['material_document_item']) > 4)) {
    ...
    public function setMaterialDocumentYear($material_document_year)
    {
        ...
        if ((mb_strlen($material_document_year) > 4)) {
            throw new \InvalidArgumentException('invalid length for $material_document_year when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setMaterialDocument($material_document)
    {
        ...
        if ((mb_strlen($material_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $material_document when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string|null $material_document_item material_document_item
     *
     * @return self
     */
    public function setMaterialDocumentItem($material_document_item)
    {
        ...
        if ((mb_strlen($material_document_item) > 4)) {
            throw new \InvalidArgumentException('invalid length for $material_document_item when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setMaterial($material)
    {
        ...
        if (!is_null($material) && (mb_strlen($material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $material when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 40.');
        }
    ...
    public function setPlant($plant)
    {
        ...
        if (!is_null($plant) && (mb_strlen($plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $plant when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setStorageLocation($storage_location)
    {
        ...
        if (!is_null($storage_location) && (mb_strlen($storage_location) > 4)) {
            throw new \InvalidArgumentException('invalid length for $storage_location when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setBatch($batch)
    {
        ...
        if (!is_null($batch) && (mb_strlen($batch) > 10)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setGoodsMovementType($goods_movement_type)
    {
        ...
        if (!is_null($goods_movement_type) && (mb_strlen($goods_movement_type) > 3)) {
            throw new \InvalidArgumentException('invalid length for $goods_movement_type when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 3.');
        }
    ...
    public function setInventoryStockType($inventory_stock_type)
    {
        ...
        if (!is_null($inventory_stock_type) && (mb_strlen($inventory_stock_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $inventory_stock_type when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 2.');
        }
    ...
    public function setInventoryValuationType($inventory_valuation_type)
    {
        ...
        if (!is_null($inventory_valuation_type) && (mb_strlen($inventory_valuation_type) > 10)) {
            throw new \InvalidArgumentException('invalid length for $inventory_valuation_type when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setInventorySpecialStockType($inventory_special_stock_type)
    {
        ...
        if (!is_null($inventory_special_stock_type) && (mb_strlen($inventory_special_stock_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $inventory_special_stock_type when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setSupplier($supplier)
    {
        ...
        if (!is_null($supplier) && (mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setCustomer($customer)
    {
        ...
        if (!is_null($customer) && (mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesOrder($sales_order)
    {
        ...
        if (!is_null($sales_order) && (mb_strlen($sales_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesOrderItem($sales_order_item)
    {
        ...
        if (!is_null($sales_order_item) && (mb_strlen($sales_order_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_item when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 6.');
        }
    ...
    public function setSalesOrderScheduleLine($sales_order_schedule_line)
    {
        ...
        if (!is_null($sales_order_schedule_line) && (mb_strlen($sales_order_schedule_line) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_schedule_line when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setPurchaseOrder($purchase_order)
    {
        ...
        if (!is_null($purchase_order) && (mb_strlen($purchase_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setPurchaseOrderItem($purchase_order_item)
    {
        ...
        if (!is_null($purchase_order_item) && (mb_strlen($purchase_order_item) > 5)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_item when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 5.');
        }
    ...
    public function setWbsElement($wbs_element)
    {
        ...
        if (!is_null($wbs_element) && (mb_strlen($wbs_element) > 24)) {
            throw new \InvalidArgumentException('invalid length for $wbs_element when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 24.');
        }
    ...
    public function setManufacturingOrder($manufacturing_order)
    {
        ...
        if (!is_null($manufacturing_order) && (mb_strlen($manufacturing_order) > 12)) {
            throw new \InvalidArgumentException('invalid length for $manufacturing_order when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 12.');
        }
    ...
    public function setManufacturingOrderItem($manufacturing_order_item)
    {
        ...
        if (!is_null($manufacturing_order_item) && (mb_strlen($manufacturing_order_item) > 4)) {
            throw new \InvalidArgumentException('invalid length for $manufacturing_order_item when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setGoodsMovementRefDocType($goods_movement_ref_doc_type)
    {
        ...
        if (!is_null($goods_movement_ref_doc_type) && (mb_strlen($goods_movement_ref_doc_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $goods_movement_ref_doc_type when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setGoodsMovementReasonCode($goods_movement_reason_code)
    {
        ...
        if (!is_null($goods_movement_reason_code) && (mb_strlen($goods_movement_reason_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $goods_movement_reason_code when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setDelivery($delivery)
    {
        ...
        if (!is_null($delivery) && (mb_strlen($delivery) > 10)) {
            throw new \InvalidArgumentException('invalid length for $delivery when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setDeliveryItem($delivery_item)
    {
        ...
        if (!is_null($delivery_item) && (mb_strlen($delivery_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $delivery_item when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 6.');
        }
    ...
    public function setAccountAssignmentCategory($account_assignment_category)
    {
        ...
        if (!is_null($account_assignment_category) && (mb_strlen($account_assignment_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $account_assignment_category when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setCostCenter($cost_center)
    {
        ...
        if (!is_null($cost_center) && (mb_strlen($cost_center) > 10)) {
            throw new \InvalidArgumentException('invalid length for $cost_center when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setControllingArea($controlling_area)
    {
        ...
        if (!is_null($controlling_area) && (mb_strlen($controlling_area) > 4)) {
            throw new \InvalidArgumentException('invalid length for $controlling_area when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setCostObject($cost_object)
    {
        ...
        if (!is_null($cost_object) && (mb_strlen($cost_object) > 12)) {
            throw new \InvalidArgumentException('invalid length for $cost_object when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 12.');
        }
    ...
    public function setGlAccount($gl_account)
    {
        ...
        if (!is_null($gl_account) && (mb_strlen($gl_account) > 10)) {
            throw new \InvalidArgumentException('invalid length for $gl_account when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setFunctionalArea($functional_area)
    {
        ...
        if (!is_null($functional_area) && (mb_strlen($functional_area) > 16)) {
            throw new \InvalidArgumentException('invalid length for $functional_area when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 16.');
        }
    ...
    public function setProfitabilitySegment($profitability_segment)
    {
        ...
        if (!is_null($profitability_segment) && (mb_strlen($profitability_segment) > 10)) {
            throw new \InvalidArgumentException('invalid length for $profitability_segment when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setProfitCenter($profit_center)
    {
        ...
        if (!is_null($profit_center) && (mb_strlen($profit_center) > 10)) {
            throw new \InvalidArgumentException('invalid length for $profit_center when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setMasterFixedAsset($master_fixed_asset)
    {
        ...
        if (!is_null($master_fixed_asset) && (mb_strlen($master_fixed_asset) > 12)) {
            throw new \InvalidArgumentException('invalid length for $master_fixed_asset when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 12.');
        }
    ...
    public function setFixedAsset($fixed_asset)
    {
        ...
        if (!is_null($fixed_asset) && (mb_strlen($fixed_asset) > 4)) {
            throw new \InvalidArgumentException('invalid length for $fixed_asset when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setMaterialBaseUnit($material_base_unit)
    {
        ...
        if (!is_null($material_base_unit) && (mb_strlen($material_base_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $material_base_unit when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 3.');
        }
    ...
    public function setEntryUnit($entry_unit)
    {
        ...
        if (!is_null($entry_unit) && (mb_strlen($entry_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $entry_unit when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 3.');
        }
    ...
    public function setCompanyCodeCurrency($company_code_currency)
    {
        ...
        if (!is_null($company_code_currency) && (mb_strlen($company_code_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $company_code_currency when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 5.');
        }
    ...
    public function setFiscalYear($fiscal_year)
    {
        ...
        if (!is_null($fiscal_year) && (mb_strlen($fiscal_year) > 4)) {
            throw new \InvalidArgumentException('invalid length for $fiscal_year when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setFiscalYearPeriod($fiscal_year_period)
    {
        ...
        if (!is_null($fiscal_year_period) && (mb_strlen($fiscal_year_period) > 7)) {
            throw new \InvalidArgumentException('invalid length for $fiscal_year_period when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 7.');
        }
    ...
    public function setFiscalYearVariant($fiscal_year_variant)
    {
        ...
        if (!is_null($fiscal_year_variant) && (mb_strlen($fiscal_year_variant) > 2)) {
            throw new \InvalidArgumentException('invalid length for $fiscal_year_variant when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 2.');
        }
    ...
    public function setIssgOrRcvgMaterial($issg_or_rcvg_material)
    {
        ...
        if (!is_null($issg_or_rcvg_material) && (mb_strlen($issg_or_rcvg_material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $issg_or_rcvg_material when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 40.');
        }
    ...
    public function setIssgOrRcvgBatch($issg_or_rcvg_batch)
    {
        ...
        if (!is_null($issg_or_rcvg_batch) && (mb_strlen($issg_or_rcvg_batch) > 10)) {
            throw new \InvalidArgumentException('invalid length for $issg_or_rcvg_batch when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setIssuingOrReceivingPlant($issuing_or_receiving_plant)
    {
        ...
        if (!is_null($issuing_or_receiving_plant) && (mb_strlen($issuing_or_receiving_plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $issuing_or_receiving_plant when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setIssuingOrReceivingStorageLoc($issuing_or_receiving_storage_loc)
    {
        ...
        if (!is_null($issuing_or_receiving_storage_loc) && (mb_strlen($issuing_or_receiving_storage_loc) > 4)) {
            throw new \InvalidArgumentException('invalid length for $issuing_or_receiving_storage_loc when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setIssuingOrReceivingStockType($issuing_or_receiving_stock_type)
    {
        ...
        if (!is_null($issuing_or_receiving_stock_type) && (mb_strlen($issuing_or_receiving_stock_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $issuing_or_receiving_stock_type when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 2.');
        }
    ...
    public function setIssgOrRcvgSpclStockInd($issg_or_rcvg_spcl_stock_ind)
    {
        ...
        if (!is_null($issg_or_rcvg_spcl_stock_ind) && (mb_strlen($issg_or_rcvg_spcl_stock_ind) > 1)) {
            throw new \InvalidArgumentException('invalid length for $issg_or_rcvg_spcl_stock_ind when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setIssuingOrReceivingValType($issuing_or_receiving_val_type)
    {
        ...
        if (!is_null($issuing_or_receiving_val_type) && (mb_strlen($issuing_or_receiving_val_type) > 10)) {
            throw new \InvalidArgumentException('invalid length for $issuing_or_receiving_val_type when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setMaterialDocumentItemText($material_document_item_text)
    {
        ...
        if (!is_null($material_document_item_text) && (mb_strlen($material_document_item_text) > 50)) {
            throw new \InvalidArgumentException('invalid length for $material_document_item_text when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 50.');
        }
    ...
    public function setGoodsRecipientName($goods_recipient_name)
    {
        ...
        if (!is_null($goods_recipient_name) && (mb_strlen($goods_recipient_name) > 12)) {
            throw new \InvalidArgumentException('invalid length for $goods_recipient_name when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 12.');
        }
    ...
    public function setUnloadingPointName($unloading_point_name)
    {
        ...
        if (!is_null($unloading_point_name) && (mb_strlen($unloading_point_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $unloading_point_name when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 25.');
        }
    ...
    public function setReservation($reservation)
    {
        ...
        if (!is_null($reservation) && (mb_strlen($reservation) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reservation when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setReservationItem($reservation_item)
    {
        ...
        if (!is_null($reservation_item) && (mb_strlen($reservation_item) > 4)) {
            throw new \InvalidArgumentException('invalid length for $reservation_item when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setReservationItemRecordType($reservation_item_record_type)
    {
        ...
        if (!is_null($reservation_item_record_type) && (mb_strlen($reservation_item_record_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $reservation_item_record_type when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setSpecialStockIdfgSalesOrder($special_stock_idfg_sales_order)
    {
        ...
        if (!is_null($special_stock_idfg_sales_order) && (mb_strlen($special_stock_idfg_sales_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $special_stock_idfg_sales_order when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setSpecialStockIdfgSalesOrderItem($special_stock_idfg_sales_order_item)
    {
        ...
        if (!is_null($special_stock_idfg_sales_order_item) && (mb_strlen($special_stock_idfg_sales_order_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $special_stock_idfg_sales_order_item when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 6.');
        }
    ...
    public function setSpecialStockIdfgWbsElement($special_stock_idfg_wbs_element)
    {
        ...
        if (!is_null($special_stock_idfg_wbs_element) && (mb_strlen($special_stock_idfg_wbs_element) > 24)) {
            throw new \InvalidArgumentException('invalid length for $special_stock_idfg_wbs_element when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 24.');
        }
    ...
    public function setIsAutomaticallyCreated($is_automatically_created)
    {
        ...
        if (!is_null($is_automatically_created) && (mb_strlen($is_automatically_created) > 1)) {
            throw new \InvalidArgumentException('invalid length for $is_automatically_created when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setMaterialDocumentLine($material_document_line)
    {
        ...
        if (!is_null($material_document_line) && (mb_strlen($material_document_line) > 6)) {
            throw new \InvalidArgumentException('invalid length for $material_document_line when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 6.');
        }
    ...
    public function setMaterialDocumentParentLine($material_document_parent_line)
    {
        ...
        if (!is_null($material_document_parent_line) && (mb_strlen($material_document_parent_line) > 6)) {
            throw new \InvalidArgumentException('invalid length for $material_document_parent_line when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 6.');
        }
    ...
    public function setHierarchyNodeLevel($hierarchy_node_level)
    {
        ...
        if (!is_null($hierarchy_node_level) && (mb_strlen($hierarchy_node_level) > 2)) {
            throw new \InvalidArgumentException('invalid length for $hierarchy_node_level when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 2.');
        }
    ...
    public function setReversedMaterialDocumentYear($reversed_material_document_year)
    {
        ...
        if (!is_null($reversed_material_document_year) && (mb_strlen($reversed_material_document_year) > 4)) {
            throw new \InvalidArgumentException('invalid length for $reversed_material_document_year when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setReversedMaterialDocument($reversed_material_document)
    {
        ...
        if (!is_null($reversed_material_document) && (mb_strlen($reversed_material_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reversed_material_document when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setReversedMaterialDocumentItem($reversed_material_document_item)
    {
        ...
        if (!is_null($reversed_material_document_item) && (mb_strlen($reversed_material_document_item) > 4)) {
            throw new \InvalidArgumentException('invalid length for $reversed_material_document_item when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setReferenceDocumentFiscalYear($reference_document_fiscal_year)
    {
        ...
        if (!is_null($reference_document_fiscal_year) && (mb_strlen($reference_document_fiscal_year) > 4)) {
            throw new \InvalidArgumentException('invalid length for $reference_document_fiscal_year when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setInvtryMgmtRefDocumentItem($invtry_mgmt_ref_document_item)
    {
        ...
        if (!is_null($invtry_mgmt_ref_document_item) && (mb_strlen($invtry_mgmt_ref_document_item) > 4)) {
            throw new \InvalidArgumentException('invalid length for $invtry_mgmt_ref_document_item when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setInvtryMgmtReferenceDocument($invtry_mgmt_reference_document)
    {
        ...
        if (!is_null($invtry_mgmt_reference_document) && (mb_strlen($invtry_mgmt_reference_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $invtry_mgmt_reference_document when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setMaterialDocumentPostingType($material_document_posting_type)
    {
        ...
        if (!is_null($material_document_posting_type) && (mb_strlen($material_document_posting_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $material_document_posting_type when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setInventoryUsabilityCode($inventory_usability_code)
    {
        ...
        if (!is_null($inventory_usability_code) && (mb_strlen($inventory_usability_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $inventory_usability_code when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setEwmWarehouse($ewm_warehouse)
    {
        ...
        if (!is_null($ewm_warehouse) && (mb_strlen($ewm_warehouse) > 4)) {
            throw new \InvalidArgumentException('invalid length for $ewm_warehouse when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setEwmStorageBin($ewm_storage_bin)
    {
        ...
        if (!is_null($ewm_storage_bin) && (mb_strlen($ewm_storage_bin) > 18)) {
            throw new \InvalidArgumentException('invalid length for $ewm_storage_bin when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 18.');
        }
    ...
    public function setDebitCreditCode($debit_credit_code)
    {
        ...
        if (!is_null($debit_credit_code) && (mb_strlen($debit_credit_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $debit_credit_code when calling APIMATERIALDOCUMENTSRVAMaterialDocumentItemType., must be smaller than or equal to 1.');
        }
     ...
     *
     * @return \BeLenka\SAP\MaterialDocument\Model\APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderType|null
     */
     ...
     *
     * @param \BeLenka\SAP\MaterialDocument\Model\APIMATERIALDOCUMENTSRVAMaterialDocumentHeaderType|null $to_material_document_header to_material_document_header
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\MaterialDocument\Model\APIMATERIALDOCUMENTSRVAMaterialDocumentItemTypeToSerialNumbers|null
     */
     ...
     *
     * @param \BeLenka\SAP\MaterialDocument\Model\APIMATERIALDOCUMENTSRVAMaterialDocumentItemTypeToSerialNumbers|null $to_serial_numbers to_serial_numbers
     *
     * @return self
     */
